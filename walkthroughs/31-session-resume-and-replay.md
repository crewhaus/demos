...
- **Module catalog reference:** §10 (sessions/event-log), §19 (branch-history), §31 (trace-viewer) in [MODULE-CATALOG.md](https://github.com/crewhaus/docs/blob/main/MODULE-CATALOG.md).
